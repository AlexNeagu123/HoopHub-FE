...
<div class="flex justify-center">
	<div
		class="card variant-filled-surface md:mx-10 my-3 w-full md:w-5/6 p-3 px-10 shadow flex flex-col justify-center"
	>
		...
		<div class="flex justify-start my-5">
			<div class="md:w-1/5">
				...
				<select
					...
					on:change={async () =>
						await updatePlayoffsSeason(standingsAvailableSeasons[selectedSeasonIndex])}
